		...
		<div id="container">
			<section id="newsWrap">
				...
				<div id="newsHeaderWrap">
					<h2>뉴스 헤더 영역</h2>
					<div id="newsHeader">
						<p class="hashTag">INSIDE VIEW</p>
						<h3 class="headLine">Coutinho, Messi and Suárez, a new alliance at the Camp Nou</h3>
						<div class="publish">
							<p class="date"><strong>WWW.FCBARCELONA.COM</strong> - 29/01/2018 | 13:32</p>
							<div class="shareArea">
								<ul>
				...
				<div id="newsAreaWrap">
					<div id="newsArea">
						<p class="imgArea">
							<img src="img/new1.jpg" alt="news1 이미지"/>
							<span class="bottomTitle">
								Coutinho, Messi and Suárez arrived together at the Stadium	
							</span>
						</p>
						<div id="textSideWrap">
							<div class="textArea">
								<strong>Philippe Coutinho</strong> started his first League match with FC Barcelona at the Camp Nou against Alavés, a game that finished 2-1. The Brazilian, who played 66 minutes, continues adapting to the Barça style with great players such as Iniesta, <strong>Suárez</strong> and <strong>Messi</strong>.<br/><br/>
