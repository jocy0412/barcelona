			...
			<section id="newsWrap">
				...
				<div id="newsHeaderWrap">
					...
					<div id="newsHeader">
						...
						<h3 class="headLine">Messi’s exhibition at the Calderón</h3>
						<div class="publish">
							<p class="date"><strong>WWW.FCBARCELONA.COM</strong> - 28/05/2017 | 17:50</p>
							<div class="shareArea">
								<ul>
						...
						<p class="descText">
							The Argentine puts in another stellar display, this time against Alavés in the Copa del Rey final
						</p>
					</div>
				</div>
				<div id="newsAreaWrap">
					<div id="newsArea">
						<p class="imgArea">
							<img src="img/new10.jpg" alt="news10 이미지"/>
							<span class="bottomTitle">
								Messi was involved in all three goals against Alavés	
							</span>
						</p>
						<div id="textSideWrap">
							<div class="textArea">
								<b>Leo Messi</b> once again showed he is the man for the big occasion with another brilliant display to help Barça claim the <b>Copa del Rey</b> against Alavés.<br/><br/>

								Messi scored the opener after an intricate one-two with <b>Neymar</b> before caressing the ball into the corner of the net.<br/><br/>

								He was also part of the move for the second, laying the ball out wide for André Gomes who squared it for Neymar to tap home.<br/><br/>
								
								And just minutes later, Messi weaved through a host of Alavés defenders before a fine through pass to <b>Paco Alcácer</b> who dispatched for the killer goal.<br/><br/>

								Enjoy Messi’s masterclass all over again with the video above.
							</div>
							<aside id="sideArea">
								<div class="latest">
									<h3>LATEST NEWS</h3>
