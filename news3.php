			...
			<section id="newsWrap">
				...
				<div id="newsHeaderWrap">
					...
					<div id="newsHeader">
						...
						<h3 class="headLine">Philippe Coutinho: 'It's going to be a special, but tough, match'</h3>
						<div class="publish">
							<p class="date"><strong>WWW.FCBARCELONA.COM</strong> - 03/02/2018 | 18:37</p>
							<div class="shareArea">
								<ul>
				...
				<div id="newsAreaWrap">
					<div id="newsArea">
						<p class="imgArea">
							<img src="img/new3.jpg" alt="news3 이미지"/>
						...
						<div id="textSideWrap">
							<div class="textArea">
								<strong>Philippe Coutinho</strong>, who made his <strong>Barça debut</strong> just over a week ago in the Copa del Rey, will be facing Espanyol in La Liga for the first time since signing with Barça. The 25-year-old Brazilian spoke to La Liga on Saturday about his memories there and his expectations for his first La Liga derby.
								
								<h4>On his time at Espanyol:</h4>
								“I have good memories from my time at Espanyol. It was a very important time for me.” “I lived in Barcelona for six months and it was a very good time for me.”
								
								<h4>On Espanyol’s current team:</h4>
								“Espanyol is a very good team, they're very skilled, but we have to go out and do what we always do. We have to go in being 100% alert, and try to play our football.”
								
								<h4>On Sunday’s game:</h4>
								“It's a derby and it's always special for the city and for everyone.”<br/><br/> 
								“I'm just like everybody else, I want to win.”<br/><br/>
								“It's a wonderful game to play and everybody prepares very well for it.”<br/><br/>
								“It's going to be a difficult and special match.”

								<p class="highLight">
									<strong>Almost six years to the day!</strong>
									Over the six months Coutinho played for Espanyol, he scored six goals and had one assist. it was during that stint when he made his Spanish football debut, coming on February 5, 2012 against Athletic Club at the San Mamés.
								</p>
							</div>
							<aside id="sideArea">
								<div class="latest">
