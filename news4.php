			...
			<section id="newsWrap">
				...
				<div id="newsHeaderWrap">
					...
					<div id="newsHeader">
						...
						<h3 class="headLine">VIDEO: Luis Suárez hits jackpot with pinball goal</h3>
						<div class="publish">
							<p class="date"><strong>WWW.FCBARCELONA.COM</strong> - 08/02/2018 | 10:00</p>
							<div class="shareArea">
								<ul>
				...
				<div id="newsAreaWrap">
					<div id="newsArea">
						<p class="imgArea">
							<img src="img/new4.jpg" alt="news4 이미지"/>
							<span class="bottomTitle">
								Don't miss Luis Suárez's entertaining goal!		
							</span>
						</p>
						<div id="textSideWrap">
							<div class="textArea">
								Everybody knows <strong>Luis Suárez</strong> has the eye of the tiger in front of the net. We've seen him score with both feet, his head, by scissors kick, volley, bicycle kick, you name it. But this time he does it a little bit differently.<br/><br/>
								
								With the ball being whacked around in a sequence reminiscent of an entropy model, Suárez puts things back in order with a goal that will leave you utterly flabbergasted!<br/><br/>
